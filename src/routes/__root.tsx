...
export const Route = createRootRoute({
  head: () => ({
    ...
    links: [
      ...
      {
        rel: 'stylesheet',
        href: 'https://fonts.googleapis.com/css2?family=Google+Sans+Code:wght@300..800&family=Google+Sans+Flex:wght@100..900&family=Noto+Sans+JP:wght@100..900&display=swap',
      },
    ],
  }),
